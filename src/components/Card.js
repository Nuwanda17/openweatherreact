        ...
        <div className="mt-5">

            {
                showData === true ? (
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body text-start mt-2">
                                        ...
                                        <h5 className="card-text">Minimun Temperature: {(weather.main.temp_min - 273.15).toFixed(1)}ºC</h5>
                                        <h5 className="card-text">Thermal Sensation: {(weather.main.feels_like- 273.15).toFixed(1)}ºC</h5>
                                        <h5 className="card-text">Hasdasdasdumidity: {weather.main.humidity}%</h5>
                    ...
                    <h2 className="text-light">Waiting for a City</h2>
                )
            }
